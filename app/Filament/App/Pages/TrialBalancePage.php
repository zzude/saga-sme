...
class TrialBalancePage extends Page implements HasForms
{
    ...
    protected string $view = 'filament.app.pages.trial-balance';
    ...
    public function exportPdf(): \Symfony\Component\HttpFoundation\Response
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('reports.trial-balance-pdf', [
            'lines'       => $result['lines'],
        ...
        return response()->streamDownload(
            fn () => print($pdf->output()),
            'trial-balance-' . now()->format('Ymd-His') . '.pdf'
        );
    }    
}
